...
// HALF and Full step Right motor reverse
// HALF and Full step LEFT motor reverse
//*********************************************************************
//----------------------------------------------------------------
// Define Constants
#include "stm32l1xx.h"
...
// used fot testing if wish to use these pins in the future	
 ...
 *----------------------------------------------------------------------------*/
void Pin_High (uint8_t num)    // based on the number of pins choses the right gpio to turn off
{
 ...
 *----------------------------------------------------------------------------*/
void Pin_Low (uint8_t num)  // based on the number of pins choses the right gpio to turn on
{
	if( num == 15 || num == 14 || num == 13 || num == 12 )
	GPIOB->BSRRH = (1<<num);
	else
...
//*****************************************************************
// KEEP THIS MAIN TO TEST IN FUTURE IF WISH TO CHANGE MOTOR IMPLEMENTATION
//*************************************************************************
/*int main (void)
{   uint32_t i=2;
	  uint32_t j=2;
...
//**********************************************************************************
// incase to use differnt pin numbers 4 5 6 7 initialized above and used for each motor
